...
- Google provider is configured if social login is enabled
...
- Google OAuth is updated with the same production domain and callback settings if Google sign-in is enabled
