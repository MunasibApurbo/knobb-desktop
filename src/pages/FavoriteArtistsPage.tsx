  ...
  if (loading) {
    return (
      <UtilityPageLayout
        ...
        description="Saved artists stay close to your library and listening flow."
        headerVisual={
          <div className="flex h-16 w-16 items-center justify-center rounded-[var(--mobile-control-radius)] border border-white/10 bg-[hsl(var(--dynamic-accent))] shadow-[0_18px_42px_rgba(0,0,0,0.28)]">
    ...
    <PageTransition>
      ...
      >
        <UtilityPageLayout
          ...
          headerVisual={
            <div className="flex h-16 w-16 items-center justify-center rounded-[var(--mobile-control-radius)] border border-white/10 bg-[hsl(var(--dynamic-accent))] shadow-[0_18px_42px_rgba(0,0,0,0.28)] sm:h-20 sm:w-20">
