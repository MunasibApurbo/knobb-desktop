...
export function UtilityPagePanel({ children, className }: UtilityPagePanelProps) {
  return (
    <section
      className={cn(
        "mobile-page-panel overflow-hidden border border-white/10 bg-white/[0.02]",
        PANEL_SURFACE_CLASS,
        className,
      )}
    >
...
export function UtilityPageLayout({
  ...
  return (
    <div
      className={cn(
        "mobile-page-shell mx-auto w-full max-w-6xl space-y-4 pb-4 md:space-y-8 md:px-6 md:pt-8 md:pb-24",
        className,
      )}
    >
