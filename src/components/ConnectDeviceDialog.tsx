      ...
      {!hideTrigger ? (
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              `player-chrome-utility relative h-9 w-9 overflow-hidden rounded-md transition-colors hover:bg-white/10 ${open || isOnExternalDevice
          ...
          >
            {triggerIcon ?? <Cast className={iconClassName} absoluteStrokeWidth />}
          </Button>
        </PopoverTrigger>
      ) : null}
      <PopoverContent
        ...
        <div className="max-h-[min(34rem,calc(100vh-9rem))] overflow-y-auto overscroll-contain">
          ...
          <div className="space-y-5 px-6 py-5">
            <button
              ...
              className={cn(
                PANEL_CARD_CLASS,
                "menu-sweep-hover group relative w-full overflow-hidden bg-white/[0.04] p-5 text-left transition-colors hover:border-white/20",
              )}
            >
              <span
                ...
                {otherDevices.map((device) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ROW_CARD_CLASS,
                        "menu-sweep-hover flex w-full items-center gap-4 px-4 py-3 text-left transition-colors",
              ...
              <div className={cn(PANEL_CARD_CLASS, "flex items-center justify-between gap-3 px-4 py-3")}>
                ...
                {canPromptForOutput && (
                  <Button
                    variant="ghost"
                    size="icon"
                    className="menu-sweep-hover shrink-0 rounded-full text-muted-foreground hover:text-foreground"
