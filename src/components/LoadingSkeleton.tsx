    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="flex items-center bg-secondary/50 rounded-md overflow-hidden">
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-4 px-4 py-2 border-b border-border/30">
        ...
        <Skeleton className="w-24 h-4 rounded ml-auto hidden md:block" />
        <Skeleton className="w-12 h-4 rounded hidden md:block" />
      </div>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 px-4 py-2.5">
          ...
          <Skeleton className="w-16 h-4 rounded hidden md:block" />
